"""TG115 Classic Windows deployer with the original Tkinter interface.

This compatibility edition intentionally preserves the pre-PySide6 layout.
The Modern PySide6 edition in ``installer.py`` remains the recommended build.
"""
...
APP_TITLE = "Telegram → 115 一键部署器 Classic"
APP_VERSION = "1.6.2"
UI_VERSION = "tk-classic-1.0"
